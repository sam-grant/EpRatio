...
int main() {
  ...
  // string output_fname2 = "inFillGainParams_sam_xtal_errors_Q.root";
  ...
  // TH1D *taus13 = new TH1D("tau_13","Calo 13",64,0,16);
  // TH1D *taus19 = new TH1D("tau_19","Calo 19",64,0,16);
  // TH1D *amps13 = new TH1D("amp_13","Calo 13",50,0,0.05);
  //TH1D *amps19 = new TH1D("amp_19","Calo 19",50,0,0.05);
  ...
  for (int stn = 13 ; stn < 20 ; stn = stn + 6 ) {
    ...
    for (int xtal = 0 ; xtal < 54 ; xtal++) {
	  ...
	  /*  double chiSqr = f1->GetChisquare();
	  double N = t_early->GetEntries();
	  if (N < 1000 || chiSqr > 100) continue;
	  cout << xtal << " " << N <<" "<< chiSqr << endl;
	  */
