...
int main() {
  ...
  string inputFname = "RootFiles/EpParameters_9day_Q.root";
  string outputFname = "RootFiles/XtalMap_9day_Q.root";
  ...
  for (int stn(13); stn < 20; stn = stn + 6) {
	  ...
	  map->Draw("COLZ");
	  c1->SaveAs(("PlotsGoldList/St"+to_string(stn)+"SurivingXtals_9day.pdf").c_str());
