...
path = "../ROOT/"
inputFileNames = [path+"RawDemoPlots_9day.root",
                path+"RawDemoPlotsCalo_9day.root",
                path+"RawDemoPlotsPositron_9day.root"]
...
for i in range(0,3):
    ...
    h1.Add(h2,+1)
    draw(h1,"../Plots/E_vs_p_"+plotNames[i]+".pdf",";Track momentum [GeV];Cluster energy [GeV]")