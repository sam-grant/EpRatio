...
def draw(h1, h2, plotName, title):
    c = TCanvas("c","",800,600)
    leg = TLegend(0.11,0.69,0.35,0.89)
...
laser = TFile.Open("../ROOT/LaserParametersProduction_60hr.root")
Ep = TFile.Open("../ROOT/EpParameters_60hr.root")

histNames = ["tau_13","tau_19","amp_13","amp_19"]
plotNames = ["../TestPlots/St13ScatterTau_60hr.pdf","../TestPlots/St19ScatterTau_60hr.pdf",
            "../TestPlots/St13ScatterAmp_60hr.pdf","../TestPlots/St19ScatterAmp_60hr.pdf"]
...
for i in range(0,4):
    ...
    if(i==1): laserHist.GetYaxis().SetRangeUser(0,30)
    if(i==2): laserHist.GetYaxis().SetRangeUser(0,0.06)
    if(i==3): laserHist.GetYaxis().SetRangeUser(-0.015,0.16)
