...
int main() {
  ...
  string outputName = "../ROOT/LaserParameters_60hr_TESTING.root";
  TFile *output = new TFile(outputName.c_str(), "recreate");
  
  ifstream laserFileTau("../Txt/laser_tau_errors_full.csv");
  ifstream laserFileA("..//Txt/laser_A_errors_full.csv");
