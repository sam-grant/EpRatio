// Code to make E/p vs E, E/p vs p, and E/p vs t 
...
int main() {
  ...
  for (int i = 0 ; i < 2 ; i++ ) { // Station Loop
    ...
    for (int j = 0 ; j < 2 ; j++ ) { // Plot region loop
	...
	name = "High Flux in Core Region (Tracker & Calo)";
      ...
      string h4 = "St"+to_string(stn)+"_Ep_vs_p_"+to_string(j);
      ...
      string fname4 = "../plots/St"+to_string(stn)+"_Profile_t_"+to_string(j)+".png";
      string fname5 = "../plots/St"+to_string(stn)+"_Profile_E_"+to_string(j)+".png";
      string fname6 = "../plots/St"+to_string(stn)+"_Ep_vs_t_"+to_string(j)+".png";
