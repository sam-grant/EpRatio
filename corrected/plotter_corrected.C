...
void Plotter::InitHistos() {
  ...
  for (int i = 0 ;  i < 4 ; i++) {
    ...
    for (int j = 0 ; j < 3 ; j++ ) {
      ...
      plot2DTr("Ep_vs_E_"+std::to_string(i)+"_"+std::to_string(j),500,0,4000,500,ymin,ymax,"E [MeV]","E/p");
      plot2DTr("Ep_vs_t_"+std::to_string(i)+"_"+std::to_string(j),150,0,5*126000,500,ymin,ymax,"t [ns]","E/p");
      plot2DTr("Ep_vs_t_early_"+std::to_string(i)+"_"+std::to_string(j),50,0,210000,500,ymin,ymax,"t [ns]", "E/p");
      plot2DTr("Ep_vs_p_"+std::to_string(i)+"_"+std::to_string(j),500,0,4000,500,ymin,ymax,"p [MeV]","E/p");
