...
void Plotter::plot1DTr(TString name, int nbins, float xlow, float xhigh, TString xtitle, TString ytitle, int col){
  /* To use the station branch use 12 and 18, to use the calo cluster branch use 13 and 19 */
...
int main(int argc, char *argv[]){
  ...
  if (argc < 2){
    ...
    fileNames.push_back("/unix/muons/g-2/omegaEU/60hr_v9_11_00/gm2rootTrees_ana_15921.root");
