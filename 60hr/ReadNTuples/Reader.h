...
class allmuonsReader : public Reader {
 ...
 allmuonsReader(TString filename):
  Reader(filename, "allmuons", "tree"){
   ...
   Bool_t          trkPassCaloVertexQuality[110];   //[nmatches]
   ...
   ULong64_t       trkLostMuonVertexQualityStatus[110]; //[nmatches]
...
private:
   ...
   TBranch        *b_trkPassCaloVertexQuality;   //!
   ...
   TBranch        *b_trkLostMuonVertexQualityStatus;
      void Init();
