...
int main() {
  ...
  string inputFname = "../ROOT/PlotsEpXtalFid_60hr.root";
  ...
  for(int stn(13); stn < 20; stn = stn + 6) {
    ...
    h2->Draw("COLZ");
    c1->SaveAs(("../TestPlots/St"+to_string(stn)+"EpMeanCmap.png").c_str());
    delete c1;
    ...
    h1->SetTitle(";Crystal;Cluster energy / track momentum");

  }

  gPad->SetGridx();
  leg->Draw("same");
  c2->SaveAs("../TestPlots/EpMeans.pdf");
