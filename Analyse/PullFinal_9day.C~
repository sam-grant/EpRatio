...
int main() {
  ...
  TH1D *dummy = new TH1D("dummy","dummy",20*factor,-7,7);
  TH1D *pullHistAmp = new TH1D("#alpha","pullHistAmp",28*factor,-7,7);//7,-0.5,3); 
  TH1D *pullHistTau = new TH1D("#tau_{r}","pullHistTau",28*factor,-7,7);//9,-3.5,1);//20*factor,-5,5);
  ...
  draw(dummy,pullHistAmp,pullHistTau,output,"Plots_9day/PullOverlay1D2.pdf",";Pull [#sigma];Entries");
