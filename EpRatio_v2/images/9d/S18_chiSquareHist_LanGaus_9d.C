void S18_chiSquareHist_LanGaus_9d()
{
...
//=========  (Thu May 14 19:49:56 2020) by ROOT version 6.12/04
   ...
   name__2->SetBinContent(53,1);
   name__2->SetBinContent(55,1);
   name__2->SetBinContent(62,1);
   name__2->SetBinContent(76,1);
   ...
   TText *ptstats_LaTex = ptstats->AddText("Mean  =   1.05 #pm 0.0214");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.148 #pm 0.0152");
   ...
   ptstats->SetTextAlign(12);
   ptstats->SetTextFont(42);
   ptstats_LaTex = ptstats->AddText("Mean  =   1.05 #pm 0.0214");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.148 #pm 0.0152");
   ptstats_LaTex = ptstats->AddText("Underflow =      0");
   ptstats_LaTex = ptstats->AddText("Overflow  =      1");
   ptstats->SetOptStat(112200);
