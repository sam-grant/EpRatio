 ...
 //   gPad->Update(); 
  ...
  int main() {
    ...
    string inputFnameEp = "../ROOT/EpParameters_60hr.root";//RootFiles/EpParameters_Q.root";
    string inputFnameLaser = "../ROOT/LaserParametersProduction_60hr.root";
    ...
    draw(dummy,pullHistAmp,pullHistTau,"../TestPlots/PullOverlay1D_60hr.pdf",";Pull [#sigma];Entries / 0.5#sigma");
